---
title: Comprendre le modèle Cascade — Manifeste
...
::manifesto-concepts
---
headline: Vocabulaire
title: "Contribution, redistribution, cycles"
description: "Le terme « Cascade » désigne à la fois la plateforme, le système, et l'objet fondamental de collecte de fonds. Une cascade est une caisse contributive orientée vers un objectif défini, connectée à d'autres cascades dans un système mutualisé. Dans ce modèle, l'enjeu n'est pas d'accumuler le plus gros montant possible mais de sécuriser des activités dans le temps, en adaptant les contributions aux besoins réels. Chaque cascade devient alors une brique active d'un système économique mutualisé, interopérable, traçable et durable. La contribution et la répartition se présentent dans ce système comme les deux moments clés, se répétant en cycles temporels."
concepts:
  - icon: i-lucide-hand-coins
    title: Contribution
    description: "Unité de base du système : l'ensemble des moyens, monétaires ou non, destinés à soutenir un objectif partagé."
  - icon: i-lucide-scale
    title: Redistribution
    description: "Le régulateur interne du système : il ajuste les déséquilibres entre contributions reçues et objectif visé."
  - icon: i-lucide-repeat
    title: Cycles
    description: "Le rythme temporel du système : des périodes définies pendant lesquelles une cascade collecte ses contributions et active ses mécanismes internes."
---
::

::manifesto-contribution
---
headline: "01 — La contribution"
title: "La contribution, unité de base du système"
intro:
...
attributes:
  ...
  - title: La contribution est régularisable
    paragraphs:
  ...
  - title: La contribution est différable
    paragraphs:
...
---
headline: "02 — La redistribution"
title: "La redistribution, régulateur interne du système"
intro:
...
surplusOriginsLabel: "S'il est facile de comprendre comment une cascade peut être déficitaire (manque de ressources et de contributeurs), le surplus peut résulter de dynamiques plus fines à saisir. Le surplus peut être :"
surplusOrigins:
...
cycleEffectsIntro: "Puisque Cascade fonctionne par cycles, ces déséquilibres ne sont pas figés dans le temps :"
cycleEffects:
...
::manifesto-cycles
---
headline: "03 — Les cycles"
title: "Les cycles, rythme temporel du système"
intro:
...
types:
  - icon: i-lucide-flag
    title: Cycles finis
    description: "Pour des projets à échéance (ex. campagne, événement, développement ponctuel)."
  - icon: i-lucide-infinity
    title: Cycles continus
    description: "Pour des activités ou services récurrents (ex. plateforme, tiers-lieux, coopérative, etc.)."
conclusion:
...
title: "La logique Cascade appliquée à des contextes très différents"
description: "Chaque cas permet de mieux comprendre comment les logiques de contribution, de redistribution et de cycle s'appliquent, tout en mettant en évidence les avantages concrets par rapport à un système économique classique."
cases:
...
title: "Ce qu'on nous oppose souvent"
objections:
  - quote: "Cascade ne garantit pas la viabilité économique d'un projet"
    paragraphs:
  ...
  - quote: "Ça manque d'information sur le fonctionnement pratique"
    paragraphs:
  ...
  - quote: "C'est super, j'adore l'idée ! Mais est-ce que ce n'est pas trop compliqué à comprendre ou à expliquer ?"
    paragraphs:
  ...
  - quote: "Est-ce que ça ne va pas décourager les financeurs institutionnels ?"
    paragraphs:
  ...
  - quote: "Pourquoi ne pas simplement faire appel à du mécénat ou du crowdfunding ?"
    paragraphs:
  ...
  - quote: "Comment être sûr que l'usage des contributions est réellement non lucratif ?"
    paragraphs:
    ...
    list:
      - "Un cadre de gouvernance partagée : les cascades peuvent être intégrées dans une fédération, ou soumises à des règles de transparence et de contrôle mutuel. Les décisions d'usage des fonds peuvent être rendues visibles, consultables et votées par les contributeurs."
      - "Un dispositif technique traçable : chaque part de contribution est fléchée vers un usage identifié (coût fixe, activité, réseau, surplus), ce qui rend toute captation visible."
      - "Un cadre juridique cohérent : Cascade s'appuie sur des modèles de licences libres et de propriété collective des outils, qui empêchent leur privatisation ultérieure. La plateforme elle-même est un commun numérique."
    paragraphsAfterList:
      - "Ce n'est pas une question de confiance dans les intentions, mais de conception d'un système qui empêche structurellement la captation privée. Le modèle est fait pour rendre la lucrativité techniquement et politiquement indésirable."
---
::
...
description: Découvrez comment ces principes se traduisent concrètement dans la plateforme.
---
::
